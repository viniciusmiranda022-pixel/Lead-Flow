  ...
  return (
    <div className="lf-card p-4">
      <div className="grid gap-3 md:grid-cols-[2fr_1fr_1fr_1fr_1fr]">
        ...
        <Select value={status} onChange={(e) => onChange({ status: e.target.value })} options={[{ label: 'Todos status', value: 'Todos' }, { label: 'Novo', value: 'Novo' }, { label: 'Contato', value: 'Contato' }, { label: 'Apresentação', value: 'Apresentação' }, { label: 'Proposta', value: 'Proposta' }, { label: 'Negociação', value: 'Negociação' }, { label: 'Pausada', value: 'Pausada' }, { label: 'Ganha', value: 'Ganha' }, { label: 'Perdida', value: 'Perdida' }]} />
